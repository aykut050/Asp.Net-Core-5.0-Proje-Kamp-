...
namespace DataAccessLayer.Concrete
{
    public class Context : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"server=LAPTOP-UHA638DA;database=CoreBlogDb;integrated security=true;");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Match>().HasOne(x => x.GuestTeam)
                .WithMany(y => y.AwayMatches).HasForeignKey(z => z.GuestTeamID).OnDelete(DeleteBehavior.ClientSetNull);
